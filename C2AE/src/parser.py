...
class Parser(object):
    ...
    def __init__(self):
        ...
        parser.add_argument("--latent_embedding_dim", default=600, help="Number of Neuorns in the Embedding", type=int)
        parser.add_argument("--lagrange", default=0.8, help="Lagrange Constant", type=float)
        parser.add_argument("--alpha", default=0.1, help="Alpha", type=float)
        parser.add_argument("--batch_size", default=128, help="Batch Size", type=int)
        parser.add_argument("--dropout", default=0.8, help="Dropout Probab. for Pre-Final Layer", type=float)

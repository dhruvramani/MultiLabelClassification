...
class Parser(object):
    ...
    def __init__(self):
        ...
        parser.add_argument("--hidden", default=700, help="Number of Units in the Hidden Layer", type=int)
        ...
        parser.add_argument("--have_patience", default=True, help="Have Patience?", type=self.str_to_bool)
        parser.add_argument("--patience", default=3, help="Patience", type=int)
